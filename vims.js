...
module.exports = function (vimscnf, fhircnf) {
  ...
  return {
    ...
    getFacilityWithLatestPeriod: function (facilities, callback) {
      return callback([{"periodId":237563,"periodName":"January 2020","total":3}])
      let periods = []
      ...
      this.getReport(facility.periodId, orchestrations, (err, report) => {
        ...
        for(let lineItemIndex in report.report.coverageAgeGroupLineItems) {
          ...
          if (lineItem.ageGroup === vimsAgeGroup) {
            ...
            // }
            // this.saveVIMSReport(updatedReport, "coverageAgeGroupLineItems", orchestrations, (err, res, body) => {
    ...
    populateCTCReferalLineItem: function (facData, facility, updatedLineItems, orchestrations, callback) {
      this.getReport(facility.periodId, orchestrations, (err, report) => {
        ...
        for(let lineItemIndex in report.report.ctcLineItems) {
          ...
          // }
          // this.saveVIMSReport(updatedReport, "ctcLineItems", orchestrations, (err, res, body) => {
      ...
      this.getReport(facility.periodId, orchestrations, (err, report) => {
        ...
        for(let bfLineItemIndex in report.report.breastFeedingLineItems) {
          ...
          if (bfLineItem.ageGroup === vimsAgeGroup) {
            ...
            // }
            // this.saveVIMSReport(updatedReport, "breastFeedingLineItems", orchestrations, (err, res, body) => {
      ...
      this.getReport(facility.periodId, orchestrations, (err, report) => {
        ...
        for(let cvLineItemIndex in report.report.childVisitLineItems) {
          ...
          if (cvLineItem.ageGroup === vimsAgeGroup) {
            ...
            // }
            // this.saveVIMSReport(updatedReport, "childVisitLineItems", orchestrations, (err, res, body) => {
      ...
      this.getReport(facility.periodId, orchestrations, (err, report) => {
        ...
        for(let ageWeightLineItemIndex in report.report.weightAgeRatioLineItems) {
          ...
          if (warLineItem.ageGroup === vimsAgeGroup) {
            ...
            // }
            // this.saveVIMSReport(updatedReport, "weightAgeRatioLineItems", orchestrations, (err, res, body) => {
    ...
    populateTTLineItem: function (facData, facility, updatedLineItems, orchestrations, callback) {
      this.getReport(facility.periodId, orchestrations, (err, report) => {
        ...
        for(let ttLineItemIndex in report.report.ttStatusLineItems) {
          ...
          // }
          // this.saveVIMSReport(updatedReport, "ttStatusLineItems", orchestrations, (err, res, body) => {
    ...
    populatePMTCTLineItem: function (facData, facility, updatedLineItems, orchestrations, callback) {
      this.getReport(facility.periodId, orchestrations, (err, report) => {
        ...
        for(let pmtctLineItemIndex in report.report.pmtctLineItems) {
          ...
          // }
          // this.saveVIMSReport(updatedReport, "pmtctLineItems", orchestrations, (err, res, body) => {
    ...
    populateMosquitoNetLineItem: function (facData, facility, updatedLineItems, orchestrations, callback) {
      this.getReport(facility.periodId, orchestrations, (err, report) => {
        ...
        for(let mosquitoNetLineItemIndex in report.report.llInLineItemLists) {
          ...
          // }
          // this.saveVIMSReport(updatedReport, "llInLineItemLists", orchestrations, (err, res, body) => {
    ...
    populateColdChainLineItem: function (facData, facility, updatedLineItems, orchestrations, callback) {
      this.getReport(facility.periodId, orchestrations, (err, report) => {
        if (err || !report) {
          return callback()
        }
        ...
        for(let lineItemIndex in report.report.coldChainLineItems) {
          let lineItem = report.report.coldChainLineItems[lineItemIndex]
        ...
        updatedLineItems.push({
          ...
          "facilityId": report.report.facilityId,
          "periodId": report.report.periodId,
          "coldChainLineItems": report.report.coldChainLineItems
        })
        return callback()
      })
    },

    saveSessionsData: function (facData, facility, updatedLineItems, orchestrations, callback) {
      this.getReport(facility.periodId, orchestrations, (err, report) => {
        if (err || !report) {
          return callback()
        }
        ...
        //   }
        // })
        updatedLineItems.push(sessionsUpdatedReport)
        return callback()
      })
    },
      ...
      this.getReport(facility.periodId, orchestrations, (err, report) => {
        ...
        async.each(facData, (data, nxtData) => {
          ...
          if (logisticsLineItem) {
            ...
            // }
            // this.saveVIMSReport(updatedReport, "Stock ON_HAND", orchestrations, (err, res, body) => {
            //   if (err) {
            //     winston.error(err)
            //   }
            // })
        ...
        async.each(facData, (data, nxtData) => {
          ...
          if (logisticsLineItemIndex) {
            ...
            */
            ...
            //   "logisticsLineItems": [logisticsLineItem]
            // }
            // this.saveVIMSReport(updatedReport, "Stock Adjustments", orchestrations, (err, res, body) => {
            //   if (err) {
            //     winston.error(err)
            //   }
            // })
